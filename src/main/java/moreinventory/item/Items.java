...
public class Items {
    ...
    public static PouchItem POUCH = (PouchItem) register("pouch", new PouchItem(null));
    public static PouchItem POUCH_WHITE = (PouchItem) register("pouch_white", new PouchItem(DyeColor.WHITE));
    public static PouchItem POUCH_ORANGE = (PouchItem) register("pouch_orange", new PouchItem(DyeColor.ORANGE));
    public static PouchItem POUCH_MAGENTA = (PouchItem) register("pouch_magenta", new PouchItem(DyeColor.MAGENTA));
    public static PouchItem POUCH_LIGHT_BLUE = (PouchItem) register("pouch_light_blue", new PouchItem(DyeColor.LIGHT_BLUE));
    public static PouchItem POUCH_YELLOW = (PouchItem) register("pouch_yellow", new PouchItem(DyeColor.YELLOW));
    public static PouchItem POUCH_LIME = (PouchItem) register("pouch_lime", new PouchItem(DyeColor.LIME));
    public static PouchItem POUCH_PINK = (PouchItem) register("pouch_pink", new PouchItem(DyeColor.PINK));
    public static PouchItem POUCH_GRAY = (PouchItem) register("pouch_gray", new PouchItem(DyeColor.GRAY));
    public static PouchItem POUCH_LIGHT_GRAY = (PouchItem) register("pouch_light_gray", new PouchItem(DyeColor.LIGHT_GRAY));
    public static PouchItem POUCH_CYAN = (PouchItem) register("pouch_cyan", new PouchItem(DyeColor.CYAN));
    public static PouchItem POUCH_PURPLE = (PouchItem) register("pouch_purple", new PouchItem(DyeColor.PURPLE));
    public static PouchItem POUCH_BLUE = (PouchItem) register("pouch_blue", new PouchItem(DyeColor.BLUE));
    public static PouchItem POUCH_BROWN = (PouchItem) register("pouch_brown", new PouchItem(DyeColor.BROWN));
